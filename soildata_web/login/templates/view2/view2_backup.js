...
.controller('View2Ctrl', function($scope,$http,$location,$route) {
	...
	$scope.gotoScheduler = function($location){
		window.location.replace('http://localhost:8000/#/scheduler')
	}
	    ...
	    for(i=0;i<cs.length;i++)
	    {
  		...
  		$scope.air_moisture = function(){
	        ...
	        for(i=0;i<20;i++)
	        {
	            ...
	            heatmap.set('opacity', heatmap.get('opacity') ? null : sensorData[count].air_moisture/100);
  		...
  		$scope.soil_moisture = function(){
	        ...
	        for(i=0;i<20;i++)
	        {
	            ...
	            heatmap.set('radius', heatmap.get('radius') ? null : 40);
	            heatmap.set('opacity', heatmap.get('opacity') ? null : sensorData[count].soil_moisture/100);
	            heatmap.set('gradient', heatmap.get('gradient') ? null : gradient);
	            heatmap.setMap(map);
	            count+=5;
	        }
  		...
  		$scope.temperature = function(){
	        ...
	        for(i=0;i<20;i++)
	        {
	            ...
	            heatmap.set('radius', heatmap.get('radius') ? null : 40);
	            heatmap.set('opacity', heatmap.get('opacity') ? null : sensorData[count].temperature/30);
	            heatmap.set('gradient', heatmap.get('gradient') ? null : gradient);
	            heatmap.setMap(map);
	            count+=5;
	        }
  		...
  		$scope.ph = function(){
	        ...
	        for(i=0;i<20;i++)
	        {
	            ...
	            heatmap.set('radius', heatmap.get('radius') ? null : 40);
	            heatmap.set('opacity', heatmap.get('opacity') ? null : sensorData[count].ph/8);
	            heatmap.set('gradient', heatmap.get('gradient') ? null : gradient);
	            heatmap.setMap(map);
	            count+=5;
	        }
  		...
  		$scope.ec = function(){
	        ...
	        for(i=0;i<20;i++)
	        {
	            ...
	            heatmap.set('radius', heatmap.get('radius') ? null : 40);
	            heatmap.set('opacity', heatmap.get('opacity') ? null : sensorData[count].ec/20);
	            heatmap.set('gradient', heatmap.get('gradient') ? null : gradient);
	            heatmap.setMap(map);
	            count+=5;
	        }
